...
let basicRequest = (() => {
  var _ref2 = asyncToGenerator(function* (url) {
    var _ref3 = yield request({ url });
...
let getTokensFromPage = (() => {
  var _ref = asyncToGenerator(function* (url) {
    const data = yield basicRequest(url);
...
let ping$1 = (() => {
  var _ref6 = asyncToGenerator(function* (url = '') {
    yield basicRequest(url);
  });
